...
$this->assign('messy',$messy);
$this->assign('phones',$phones);
$this->assign('burgers',$burgers);
$this->assign('trump',$trump);
$this->assign('trump',$trump);
?>
<!DOCTYPE html>
<html>
    ...
    <div class="row">
            ...
            <div class="panel panel-orange panel-widget ">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large"><?=$this->fetch('messy')?></div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="panel panel-teal panel-widget">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large"><?=$this->fetch('phones')?></div>
                        <div class="text-muted">Total Number of Phones</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="panel panel-blue panel-widget">
                <div class="row no-padding">
                    <div class="col-sm-3 col-lg-5 widget-left">
                        <svg class="glyph stroked bacon-burger"><use xlink:href="#stroked-bacon-burger"></use></svg>
                    </div>
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large"><?=$this->fetch('burgers')?></div>
                        <div class="text-muted">Dev Cheezburgers</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="panel panel-red panel-widget">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large"><?=$this->fetch('trump')?></div>
                        <div class="text-muted">Morons for Trump</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <a href="/Sms/add"><button class="btn btn-primary btn-md" id="btn-todo" style="margin-top:25px;margin-left:25px;">Send New SMS Message</button></a>
                </span>
