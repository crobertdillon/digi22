...
<?= $this->Form->button(__('Add Brand Spanking New SMS List'),['class' => 'btn btn-primary','style'=>'margin:25px;']); ?><a class="btn btn-primary" style="margin-left:25px;" href="/Smslist">Cancel</a>
